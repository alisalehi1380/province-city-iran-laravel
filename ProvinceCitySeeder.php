...
class ProvinceCitySeeder extends Seeder
{
    ...
    {
        foreach ($this->provinceAndCities() as $province => $cities) {
            $Province = Province::create([Province::NAME => $province]);
            foreach ($cities as $city) {
                City::create([
                    City::STATE_ID => $Province->id,
                    City::NAME => $city,
                ]);
            }
        }
    ...
    public function provinceAndCities(): array
    {
        return [
            ...
            'تهران' => ['ورامین', 'فیروزکوه', 'شهریار', 'شمیرانات', 'ری', 'رباط‌کریم', 'دماوند', 'تهران', 'پاکدشت', 'اسلام‌شهر', 'قدس', 'ملارد', 'بهارستان', 'پردیس', 'بومهن', 'رودهن', 'قرچک', 'پیشوا', 'صالحیه', 'گلستان', 'اندیشه', 'پرند', 'باغستان', 'باقرشهر', 'نسیم شهر', 'صباشهر', 'چهاردانگه', 'حسن‌آباد', 'وحیدیه', 'نصیرشهر', 'فردوسیه', 'شاهدشهر', 'صفادشت', 'لواسان', 'آبسرد', 'شریف‌آباد', 'کهریزک', 'فشم', 'جوادآباد', 'فرون آباد', 'آبعلی', 'کیلان', 'شمشک', 'احمدآباد مستوفی', 'ارجمند', 'قلعه‌نو (ری)', 'قیام‌دشت', 'سعیدآباد (پردیس)', 'خسروآباد (پردیس)', 'جلیل‌آباد (ورامین)'],
